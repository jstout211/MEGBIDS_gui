...
def main():
    ...
    parser.add_argument('-o','--output', help="Enter output BIDS directory", required=False, nargs='+')
    parser.add_argument('-m','--MEG', help='Enter path of MEG folder', required=False, nargs='+')
    parser.add_argument('-n','--NIFTI', help='Enter path of NIFTI folder', required=False, nargs='+')
    parser.add_argument('-t','--transformatrix', help='Enter path of transform matrix', required=False, nargs='+')
